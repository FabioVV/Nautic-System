...
export class AppConfigurator {
    ...
    ngOnInit() {
        if (isPlatformBrowser(this.platformId)) {
            this.onPresetChangeStartup(this.layoutService.layoutConfig().preset);
        }

        const event = this.themeService.getThemePreset()
    ...
    updateColors(event: any, type: string, color: any) {
        ...
        this.themeService.saveThemeSurfaceColorsMode(type, color.name, color)
    ...
    onPresetChangeStartup(event: any) {
    ...
    onPresetChange(event: any) {
        this.themeService.saveThemePreset(event) // saves the preset choosen in the localstorage
