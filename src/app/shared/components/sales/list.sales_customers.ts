    ...
    >
        <ng-template #caption>
            ...
            <div class="flex flex-wrap items-center justify-end gap-2">
                ...
                <p-iconfield>
                    <p-inputicon styleClass="pi pi-search" />
                    <input [(ngModel)]="emailSearch" pInputText type="text" (input)="onGlobalFilter($event)" placeholder="E-mail..." />
                </p-iconfield>


                <p-iconfield>
                    <p-inputicon styleClass="pi pi-search" />
                    <input [(ngModel)]="phoneSearch" pInputText type="text" (input)="onGlobalFilter($event)" placeholder="Telefone..." />
                </p-iconfield>
