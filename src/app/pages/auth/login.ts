...
@Component({
    ...
    template: `
        ...
        <p-toast></p-toast>
        <div style='background-image: url(/assets/images/boat1.jpg); background-repeat: no-repeat; background-size: cover;  background-position: center;' class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
